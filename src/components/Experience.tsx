...
const experiences = [
    {
        ...
        description: "Built and scaled a production-grade HRMS & Finance platform using FastAPI, delivering 300+ async REST APIs. Designed 70+ optimized PostgreSQL tables for payroll, attendance, and approval workflows. Engineered a role-based approval system with multi-level workflows, audit trails, and JWT-based RBAC."
    },
    {
