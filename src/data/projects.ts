...
<<<<<<< HEAD
        ...
        tech: ["React.js", "FastAPI", "Python", "Leaflet.js", "NumPy", "Chart.js", "Pydantic", "Axios"],
        link: "https://droptimizer.netlify.app/",
        github: "https://github.com/raihanahmadkhan/delivery-backend",
        emoji: "🚚",
        featured: true,
        status: "completed",
        category: "Full-Stack",
        problem: "With the rapid growth of e-commerce and on-demand services, traditional manual route planning becomes inefficient and infeasible. Optimizing delivery routes while satisfying real-world constraints such as vehicle capacity, delivery time windows, and route limits is a complex challenge.",
        solution: "An intelligent optimization system combining heuristic and metaheuristic algorithms (ACO, GA, PSO) with constraint-aware routing. Features interactive map-based visualization using Leaflet.js and a benchmarking framework for algorithm comparison.",
        features: [
            "Multi-algorithm engine: ACO, Genetic Algorithm, PSO, Nearest Neighbor, and Random Baseline",
            "Constraint-aware routing with time windows, vehicle capacity, fleet size, and max route distance",
            "Interactive map visualization with Leaflet.js for real-time route analysis",
            "Benchmarking system comparing algorithms on distance, violations, and computational efficiency",
            "28–43% reduction in total route distance over baseline methods",
            "Up to 91% decrease in constraint violations with metaheuristic approaches"
        ],
